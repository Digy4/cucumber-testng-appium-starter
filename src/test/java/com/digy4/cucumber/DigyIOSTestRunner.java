...
@CucumberOptions(
		...
		glue = {"com.digy4.cucumber.steps","com.digy4.java.mobiletesting.cucumber.ios"},
		plugin = {"pretty","json:target/cucumber/report.json", "html:target/cucumber/report.html",
				  "com.digy4.java.mobiletesting.cucumber.ios.Digy4IOSAppCucumberSupport"}
		)
public class DigyIOSTestRunner extends AbstractTestNGCucumberTests {
	@Override
